main: \
  ...
  /usr/local/lib/libChrono_vehicle_irrlicht.so \
  /usr/local/lib/libChronoModels_vehicle.so \
  /usr/local/lib/libChrono_vehicle.so \
  /usr/local/lib/libChrono_irrlicht.so \
  /usr/local/lib/libChronoModels_robot.so \
